...
static struct proc_ops proc_fops = {
    .proc_read  = media_read,       // Direccionamos la lectura a la función media_read
    .proc_write = media_write       // Direccionamos la escritura a la función media_write
};


static int __init media_init(void) {                                        // Creamos la entrada en proc
...
static void __exit media_exit(void) {                   // Elimina la entrada en proc
...
module_init(media_init);    // Direcciona la inicialización del módulo a media_init
module_exit(media_exit);    // Direcciona la finalización del módulo a media_exit
